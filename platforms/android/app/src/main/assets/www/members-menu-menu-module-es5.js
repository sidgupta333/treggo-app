...
var routes = [
    {
        ...
        children: [
            { path: 'dashboard', loadChildren: function () { return Promise.all(/*! import() | dashboard-dashboard-module */[__webpack_require__.e("common"), __webpack_require__.e("dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! ../dashboard/dashboard.module */ "./src/app/members/dashboard/dashboard.module.ts")).then(function (m) { return m.DashboardPageModule; }); } },
            { path: 'status', loadChildren: function () { return Promise.all(/*! import() | status-status-module */[__webpack_require__.e("common"), __webpack_require__.e("status-status-module")]).then(__webpack_require__.bind(null, /*! ../status/status.module */ "./src/app/members/status/status.module.ts")).then(function (m) { return m.StatusPageModule; }); } }
        ]
    }
];
...
var MenuPage = /** @class */ (function () {
    ...
    MenuPage.prototype.navigateToDashboard = function () {
        this.router.navigate(['menu', 'dashboard']);
    };
    MenuPage.prototype.navigateToStatus = function () {
...
//# sourceMappingURL=members-menu-menu-module-es5.js.map