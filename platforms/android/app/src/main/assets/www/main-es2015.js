...
const routes = [
    ...
    { path: 'menu', loadChildren: () => __webpack_require__.e(/*! import() | members-menu-menu-module */ "members-menu-menu-module").then(__webpack_require__.bind(null, /*! ./members/menu/menu.module */ "./src/app/members/menu/menu.module.ts")).then(m => m.MenuPageModule) },
    { path: 'confirm-order', loadChildren: () => Promise.all(/*! import() | members-confirm-order-confirm-order-module */[__webpack_require__.e("common"), __webpack_require__.e("members-confirm-order-confirm-order-module")]).then(__webpack_require__.bind(null, /*! ./members/confirm-order/confirm-order.module */ "./src/app/members/confirm-order/confirm-order.module.ts")).then(m => m.ConfirmOrderPageModule) }
];
